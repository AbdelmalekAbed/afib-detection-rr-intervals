...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/03_class_imbalance_per_patient.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/02_rr_distribution.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/10_optuna_search.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/12_phase3_ablation.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/17_phase4b_size_vs_f1.pdf}
  \caption{Compromis taille / performance des variantes de compression.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/18_phase5_perpatient_box.pdf}
